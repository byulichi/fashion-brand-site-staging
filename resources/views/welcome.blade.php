...
<body>
    ...
    <main class="container-fluid">
                ...
                <div id="heroCarousel" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="https://via.placeholder.com/1200x400?text=Sale+Up+to+70%25" class="d-block w-100"
                                alt="Sale Banner">
                        </div>
        ...
        <div class="row mt-5 justify-content-center">
            ...
            <div class="col-md-2 text-center mb-3">
                <img src="https://via.placeholder.com/300x300?text=Ready+To+Wear" class="img-fluid rounded-circle mb-2"
                    alt="Ready To Wear">
                <h4>Ready To Wear</h4>
            </div>
            <div class="col-md-2 text-center mb-3">
            ...
            <div class="col-md-2 text-center mb-3">
                <img src="https://via.placeholder.com/300x300?text=Accessories" class="img-fluid rounded-circle mb-2"
                    alt="Accessories">
                <h4>Accessories</h4>
            </div>
        </div>
        ...
        <div class="container-fluid my-5">
            <div class="row">
                <div class="col-md-4 d-flex flex-column justify-content-center">
                    <h2>New Arrivals</h2>
                    <p>
                        Browse our newest array of prints, everyday wear, and accessories to craft a fashion-forward and
                        confident look.
