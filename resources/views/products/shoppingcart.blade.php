                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="mb-0">SKU: {{ $cartItem->item->id }}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>RM {{ number_format($cartItem->item->price, 2) }}</td>
                                            <td>
                                                <form action="{{ route('cart.update', $cartItem->id) }}" method="POST">
                                                    @csrf
                                                    <div class="input-group" style="width: 120px;">
                                                        <button class="btn btn-outline-secondary" type="submit" name="quantity" value="{{ $cartItem->quantity - 1 }}">-</button>
                                            ...
                                            <td>RM {{ number_format($cartItem->item->price * $cartItem->quantity, 2) }}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">RM {{ number_format($cartItems->sum(function($cartItem) { return $cartItem->item->price * $cartItem->quantity; }), 2) }}</p>
